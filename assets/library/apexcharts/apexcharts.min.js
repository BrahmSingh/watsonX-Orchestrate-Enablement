    ...
    var A = {
      ...
      , T = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i, a, s, r, n) {
                ...
                if ("circle" === m.shape ? o = f.drawCircle(i) : "square" !== m.shape && "rect" !== m.shape || (o = f.drawRect(0, 0, m.width - m.pointStrokeWidth / 2, m.height - m.pointStrokeWidth / 2, m.pRadius)),
                ...
                if (l.globals.dataChanged && "circle" === m.shape)
                    if (this.dynamicAnim) {
                        ...
                        null != (C = l.globals.previousPaths[s] && l.globals.previousPaths[s][n]) && (k = C.x,
                        A = C.y,
                        S = void 0 !== C.r ? C.r : a);
                        for (var z = 0; z < l.globals.collapsedSeries.length; z++)
                            l.globals.collapsedSeries[z].index === s && (T = 1,
                            a = 0);
                        0 === t && 0 === e && (a = 0),
                        c.animateCircle(o, {
                            cx: k,
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var x = e
                  , m = e + i
                  , v = d.line(a, m - r);
                return f = f + d.line(u.x2, x) + u.pathWithRadius + d.line(u.x2, m - r) + v + v + "z",
            ...
            value: function(t, e, i, a, s) {
                ...
                if (t.config.chart.stacked && i.length > 1 && a !== this.barCtx.radiusOnSeriesNumber && (n = 0),
                this.barCtx.isHorizontal) {
                    var o = ""
                      , l = e.x2;
                    if (Math.abs(e.x1 - e.x2) < n && (n = Math.abs(e.x1 - e.x2)),
                    void 0 !== i[a][s] || null !== i[a][s]) {
                        var h = this.barCtx.isReversed ? i[a][s] > 0 : i[a][s] < 0;
                        h && (n *= -1),
                        l -= n,
                        o = r.quadraticCurve(l + n, e.barYPosition, l + n, e.barYPosition + (h ? -1 * n : n)) + r.line(l + n, e.barYPosition + e.barHeight - e.strokeWidth - (h ? -1 * n : n)) + r.quadraticCurve(l + n, e.barYPosition + e.barHeight - e.strokeWidth, l, e.barYPosition + e.barHeight - e.strokeWidth)
                    }
                    return {
                        pathWithRadius: o,
                        x2: l
                ...
                var c = ""
                  , d = e.y2;
                if (Math.abs(e.y1 - e.y2) < n && (n = Math.abs(e.y1 - e.y2)),
                void 0 !== i[a][s] || null !== i[a][s]) {
                    var g = i[a][s] < 0;
                    g && (n *= -1),
                    d += n,
                    c = r.quadraticCurve(e.barXPosition, d - n, e.barXPosition + (g ? -1 * n : n), d - n) + r.line(e.barXPosition + e.barWidth - e.strokeWidth - (g ? -1 * n : n), d - n) + r.quadraticCurve(e.barXPosition + e.barWidth - e.strokeWidth, d - n, e.barXPosition + e.barWidth - e.strokeWidth, d)
                }
                return {
                    pathWithRadius: c,
                    y2: d
      ...
      , F = function(t) {
        ...
        return a(s, [{
            ...
            value: function(t) {
                ...
                Number.isFinite(s) && Number.isFinite(r) && (o = s,
                l = r,
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                for (var o = 0; o < t[e].data.length; o++)
                    void 0 !== t[e].data[o][2] && (this.threeDSeries.push(t[e].data[o][2]),
                    a.isDataXYZ = !0)
            }
        }, {
            key: "handleFormatXY",
                    ...
                    n.globals.axisCharts ? function(t, e) {
                        ...
                        t.data && t.data.length)
                            for (var s = 0; s < t.data.length; s++) {
                                ...
                                0 === e) {
                                    o.push((d = r,
                                    "datetime" === n.config.xaxis.type && String(d).length >= 10 ? n.config.chart.toolbar.export.csv.dateFormatter(r) : f.isNumber(r) ? r : r.split(a).join("")));
                                ...
                                ("boxPlot" === n.config.chart.type || t.type && "boxPlot" === t.type) && (o.pop(),
                                o.push(n.globals.seriesCandleO[e][s]),
                                o.push(n.globals.seriesCandleH[e][s]),
                        ...
                        var d
                    }(t, e) : ((o = []).push(n.globals.labels[e].split(a).join("")),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                var r = t.config.chart.type
                  , n = 0
                  , o = 0;
                ("bar" === r || "rangeBar" === r || "candlestick" === r || "boxPlot" === r || t.globals.comboBarCount > 0) && t.globals.isXNumeric && !t.globals.isBarHorizontal && (n = t.config.grid.padding.left,
            ...
            value: function(t) {
                ...
                for (var d = t; d < a; d++) {
                    ...
                    for (var g = 0; g < r.series[d].length; g++) {
                        var u = l[d][g];
                        null !== u && f.isNumber(u) ? (void 0 !== c[d][g] && (n = Math.max(n, c[d][g])),
                        void 0 !== h[d][g] && (e = Math.min(e, h[d][g]),
                        i = Math.max(i, h[d][g])),
                        "candlestick" !== this.w.config.chart.type && "boxPlot" !== this.w.config.chart.type || (void 0 !== r.seriesCandleC[d][g] && (n = Math.max(n, r.seriesCandleO[d][g]),
                        ...
                        !s.series[d].type || "candlestick" === s.series[d].type && "boxPlot" === s.series[d].type || (n = Math.max(n, r.series[d][g]),
      ...
      , ht = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                var t = this.w;
                t.globals.isTimelineBar && (this.minX = t.globals.minY,
            ...
            value: function() {
                var t = this.w;
                if (t.globals.isTimelineBar && (this.minX = t.globals.minY,
                this.maxX = t.globals.maxY),
      ...
      , ct = function(t) {
        ...
        return a(s, [{
            ...
            value: function(t) {
                ...
                var h = void 0
                  , c = void 0;
                a.globals.isTimelineBar ? (h = a.globals.yAxisScale[0].niceMin + s.startX * r.invertedYRatio,
            ...
            value: function(t, e) {
                var i = this.w
                  ...
                  , n = i.globals.minX
                  , o = i.globals.maxX;
                i.globals.isTimelineBar && (r = a.invertedYRatio,
                n = i.globals.minY,
                o = i.globals.maxY),
                "left" === this.moveDirection ? (t = n + i.globals.gridWidth / 15 * r,
                e = o + i.globals.gridWidth / 15 * r) : "right" === this.moveDirection && (t = n - i.globals.gridWidth / 15 * r,
                e = o - i.globals.gridWidth / 15 * r),
                i.globals.isTimelineBar || (t < i.globals.initialMinX || e > i.globals.initialMaxX) && (t = n,
                e = o);
                var l = {
                    min: t,
                    max: e
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var g = a - c.left - r.globals.barPadForNumericAxis
                  , u = s - c.top;
                g < 0 || u < 0 || g > r.globals.gridWidth || u > r.globals.gridHeight ? (e.classList.remove("hovering-zoom"),
                ...
                var p = Math.round(g / l)
                  , x = Math.floor(u / h);
                d && !r.config.xaxis.convertedCatToNumeric && (p = Math.ceil(g / l),
                p -= 1);
                ...
                r.globals.isXNumeric && (m = (v = this.closestInMultiArray(g, u, y, b)).index,
                p = v.j,
                null !== m && (y = r.globals.seriesXvalues[m],
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                a.config.tooltip.followCursor) {
                    ...
                    a.globals.isBarHorizontal ? h -= n.ttHeight : (n.ttHeight / 2 + h > a.globals.gridHeight && (h = a.globals.gridHeight - n.ttHeight + a.globals.translateY),
                    h < 0 && (h = 0));
            ...
            value: function(t) {
                ...
                if (e.globals.isXNumeric ? (n -= a % 2 != 0 ? l / 2 : 0,
                r && (r.classList.contains("apexcharts-candlestick-area") || r.classList.contains("apexcharts-boxPlot-area")) && e.globals.comboCharts && (n -= l / 2)) : e.globals.isBarHorizontal || (n = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2,
      ...
      , pt = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (h + n.tooltipRect.ttWidth > r.globals.gridWidth && !p ? h -= n.tooltipRect.ttWidth : h < 0 && (h = 0),
                n.w.config.tooltip.followCursor) {
                ...
                !n.fixedTooltip && (!r.config.tooltip.shared || r.globals.isBarHorizontal && n.tooltipUtil.hasBars()) && (p && (h -= n.tooltipRect.ttWidth) < 0 && (h = 0),
      ...
      , bt = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                if (t.globals.axisCharts && (s ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : a ? o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-boxPlot-area, .apexcharts-series .apexcharts-rangebar-area") : "heatmap" !== e && "treemap" !== e || (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap, .apexcharts-series .apexcharts-treemap")),
                o && o.length))
      ...
      , vt = function(t) {
        ...
        return a(s, [{
            ...
            value: function(t) {
                ...
                var C = l.move(S, r)
                  , L = l.move(S + s / 2, w);
                return o.globals.previousPaths.length > 0 && (L = this.getPreviousPath(x, c, !0)),
                C = this.isBoxPlot ? [l.move(S, w) + l.line(S + s / 2, w) + l.line(S + s / 2, v) + l.line(S + s / 4, v) + l.line(S + s - s / 4, v) + l.line(S + s / 2, v) + l.line(S + s / 2, w) + l.line(S + s, w) + l.line(S + s, A) + l.line(S, A) + l.line(S, w + n / 2), l.move(S, A) + l.line(S + s, A) + l.line(S + s, k) + l.line(S + s / 2, k) + l.line(S + s / 2, y) + l.line(S + s - s / 4, y) + l.line(S + s / 4, y) + l.line(S + s / 2, y) + l.line(S + s / 2, k) + l.line(S, k) + l.line(S, A) + "z"] : [l.move(S, k) + l.line(S + s / 2, k) + l.line(S + s / 2, v) + l.line(S + s / 2, k) + l.line(S + s, k) + l.line(S + s, w) + l.line(S + s / 2, w) + l.line(S + s / 2, y) + l.line(S + s / 2, w) + l.line(S, w) + l.line(S, k - n / 2)],
                L += l.move(S, w),
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                s.series.map((function(e, g) {
                    ...
                    h.i.push(g),
                    u++,
                    i.globals.columnSeries = h.series) : "area" === t[g].type ? (n.series.push(e),
                    n.i.push(g),
                    u++) : "line" === t[g].type ? (r.series.push(e),
                    r.i.push(g),
                    u++) : "scatter" === t[g].type ? (o.series.push(e),
                    o.i.push(g)) : "bubble" === t[g].type ? (l.series.push(e),
                    l.i.push(g),
                ...
                var p = new St(this.ctx)
                  , x = [];
                if (s.comboCharts) {
                    if (n.series.length > 0 && x.push(g.draw(n.series, "area", n.i)),
                    h.series.length > 0)
